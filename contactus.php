						...
						<div class="sidebar">
							<div class="widget_info">
								...
								<ul class="widget_info_contact">
									...
									<li><i class="fa fa-user"></i> <p><strong>Phone</strong>:02118-254620</p></li>
									<li><i class="fa fa-envelope"></i> <p><strong>Email</strong>: <a href="#">svems.kalamb@dkkkpsvems.com</a></p></li>
									<li><i class="fa fa-globe"></i> <p><strong>Web</strong>: <a href="#" data-placement="bottom" data-toggle="tooltip" title="www.dkkkppgs.com">www.dkkkpsvems.com</a></p></li>
								</ul>
