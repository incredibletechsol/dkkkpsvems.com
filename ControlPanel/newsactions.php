	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "save")
				...
				mysqli_query($conn,$news_insert) or die(mysqli_error($conn));
			
				$log->info("News Data inserted");
				
				$message="DKKKPSVEMS.COM :: 1 News Inserted";
	...
	if(isset($_GET['msg']))
		{
			...
			if($param == "delete")
				...
				mysqli_query($conn,$news_delete) or die(mysqli_error($conn));
				$log->info("News Data Deleted");
				$message="DKKKPSVEMS.COM :: 1 News Deleted";
     			?>
